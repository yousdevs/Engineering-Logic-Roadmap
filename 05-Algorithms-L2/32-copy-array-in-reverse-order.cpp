...
void copyArrayInReverseOrder(int sourceArray[100], int targetArray[100], int sourceSize) {
	for (int i = 0; i < sourceSize; i++) {
		targetArray[i] = sourceArray[sourceSize-i-1];
	}
}
...
int main() {
	...
	int targetArray[100] = {};
	copyArrayInReverseOrder(array, targetArray, size);
	std::cout << std::endl;
	std::cout << "Reversed ";
	printArrayValues(targetArray, size);
	return 0;
}