...
int main() {
	...
	if (foundClient.found) {
		...
		std::cout << "\nClient Found: \n";
		std::cout << "Account Number: " << foundClient.client.accountNumber << std::endl;
		std::cout << "Pin Code: " << foundClient.client.pinCode << std::endl;
		std::cout << "Full Name: " << foundClient.client.fullName << std::endl;
		std::cout << "Phone Number: " << foundClient.client.phoneNumber << std::endl;
		std::cout << "Balance: " << foundClient.client.balance << std::endl;
	}
	else {
