...
DateInfo calculateVacationReturnDate(DateInfo startDate, int vacationDays){
...
void printVacationReturnDay(int startDay, int startMonth, int startYear, int vacationDays)
{
    DateInfo startDate = getDateInfo(startYear, startMonth, startDay);
    DateInfo endDate = calculateVacationReturnDate(startDate, vacationDays);
...
int main()
{
    ...
    //int vacationDays = mylib::readValidInteger("Please enter vacation Days (e.g., 2): ");

    printVacationReturnDay(1, 1, 2022, 23);
