...
void printDaysFromBeginningOfYear(short year, short month, short day) {
    std::cout << "Total days From Beginning of the year: " << calculateTotalDaysFromBeginningOfYear(year, month, day);
}
...
int main()
{
    ...
    printDaysFromBeginningOfYear(year, month, day);
}